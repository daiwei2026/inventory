    ...
    <div id="right">
        ...
        if ((($_FILES["image"]["type"] == "image/gif")
            ...
            if ($_FILES["image"]["error"] > 0) {
                ...
                $sql = "INSERT INTO goods (category,name,price,store,sell,image,date) VALUES ('" . $_POST["category"] . "','" . $_POST["name"] . "','" . $_POST["price"] . "','" . $_POST["store"] . "','" . $_POST["sell"] . "','" . "images/" . $_FILES["image"]["name"] . "','" . date("Y 年 m 月 d 日 H 点 i 分 s 秒") . "')";
